  ...
  return (
    <div className="max-w-[800px] mx-auto px-6 py-24 md:py-32 flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-8 text-[16px] md:text-[18px] leading-[1.7] text-[rgba(0,0,0,0.7)]">
        <section>
          <h2 className="text-xl font-semibold text-black mb-2">Article 1 : Préambule</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-2">Article 2 : Responsable du traitement</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-2">Article 3 : Nature des données collectées</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-2">Article 4 : Finalité du traitement</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-2">Article 5 : Hébergement et transmission des données</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-2">Article 6 : Durée de conservation</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-2">Article 7 : Politique en matière de Cookies</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-2">Article 8 : Droits des utilisateurs</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-2">Article 9 : Modification de la politique de confidentialité</h2>
