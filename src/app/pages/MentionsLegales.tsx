  ...
  return (
    <div className="max-w-[800px] mx-auto px-6 py-24 md:py-32 flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-8 text-[16px] md:text-[18px] leading-[1.7] text-muted-foreground">
        ...
        <section>
          <h2 className="text-xl font-semibold text-foreground mb-2">2. Hébergement du site</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-foreground mb-2">3. Propriété intellectuelle et contrefaçons</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-foreground mb-2">4. Limitations de responsabilité</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-foreground mb-2">5. Gestion des données personnelles</h2>
